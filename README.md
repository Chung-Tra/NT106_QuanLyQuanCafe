...
- **Tính năng AI**: Chatbot Gemini hỗ trợ giải đáp nghiệp vụ, Chat realtime nội bộ quán.
...
## 🏗️ Kiến trúc & thư mục
```tree
NT106_QuanLyQuanCafe/
├─ QuanCafe_API/         # Backend FastAPI, SQLite/Postgres, AI client
│  ├─ app/               # Mã nguồn chính (auth, pos, menu, inventory, chat...)
